...
const RemoveModal = ({ isOpen, onClose, onConfirm, isLoading = false }: RemoveModalProps) => {
  ...
  const isConfirmEnabled = confirmText === '삭제합니다.';
    ...
    <div className={styles.overlay} onClick={e => e.target === e.currentTarget && handleClose()}>
      <div className={styles.modal}>
        ...
        <div className={styles.content}>
          <p className={styles.inputLabel}>'삭제합니다.'를 입력해주세요</p>
          <Input
            value={confirmText}
